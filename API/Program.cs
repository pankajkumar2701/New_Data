...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "NewData", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<NewDataContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "NewData API v1");
